#!/bin/bash
# Script: hyprsunset_decrease.sh
# Diminue la température (plus de filtre bleu)
...
/usr/bin/notify-send "Hyprsunset" "Température: ${new_temp}K (plus chaud)" -t 2000 2>/dev/null || true
